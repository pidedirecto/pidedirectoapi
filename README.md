...
| modifierGroups[i].modifiers[j].sku                                        | string &#124; undefined        | SKU of the modifier                                                   |
...
| tips[i].customPaymentMethod                                                                             | string &#124; undefined                                                                                                                                                                                                                                                 | The custom payment method for the tip                                                                                                                                                                                                                                                                                       |
...
| cancelledAt                                                                                             | string (Date) &#124; undefined                                                                                                                                                                                                                                          | Date the order cancelled.                                                                                                                                                                                                                                                                                                   |
...
| items                                                      | Array &#124; undefined                                                                        | Order line items. Product IDs must match those returned by [getStoreMenu](#POST-getStoreMenu). If omitted, the order is created without item details.                                                                                              |
...
| items[i].externalProductId                                 | string &#124; undefined                                                                       | External product ID from getStoreMenu. Used to identify the product in your system.                                                                                                                                                                |
...
| items[i].note                                              | string &#124; undefined                                                                       | Customer note for this item (e.g. "no ice").                                                                                                                                                                                                       |
| items[i].modifierGroups                                    | Array &#124; undefined                                                                        | Modifier groups for this item (e.g. size, extras). IDs must match getStoreMenu.                                                                                                                                                                    |
...
| items[i].modifierGroups[j].externalModifierGroupId         | string &#124; undefined                                                                       | External modifier group ID from getStoreMenu.                                                                                                                                                                                                      |
| items[i].modifierGroups[j].modifiers                       | Array &#124; undefined                                                                        | Modifiers selected in this group.                                                                                                                                                                                                                  |
...
| items[i].modifierGroups[j].modifiers[k].externalModifierId | string &#124; undefined                                                                       | External modifier ID from getStoreMenu.                                                                                                                                                                                                            |
...
| discountType   | string ( <br/> &nbsp;&nbsp;"PERCENT" <br/> &nbsp;&nbsp;"AMOUNT" <br/> )                                                      | The type of discount                                        |
| customerIds    | Array &#124; undefined                                                                                                       | Optional array of customer IDs that can use this promo code |
...
| paymentMethods                          | Array &#124; undefined         | List of enabled payment methods configured for the store             |
...
| total                                                                                                   | string (number)                                                                                                                                                         | Total cost that the customer pays for the order (delivery cost included)                                                                                                                                                                                                                                                    |
| paymentLinkUrl                                                                                          | string                                                                                                                                                                  | Payment link URL, exists only if paymentMethod is "PAYMENT_LINK".                                                                                                                                                                                                                                                           |
| paymentMethod                                                                                           | string ( <br/> &nbsp;&nbsp;"CARD" <br/> &nbsp;&nbsp;"CASH" <br/> &nbsp;&nbsp;"CARD_ON_DELIVERY" &nbsp;&nbsp;"PAYMENT_LINK" <br/> &nbsp;&nbsp;"PAYMENT_TERMINAL" <br/> ) | The payment method of the delivery address. Can be either "CARD", "CASH", "CARD_ON_DELIVERY", "PAYMENT_LINK", or "PAYMENT_TERMINAL". If "CARD" the driver will not charge customer anything.                                                                                                                                |
| cardNumber                                                                                              | string &#124; undefined                                                                                                                                                 | The card number with the following format " \*\*\*\*last 4 digits ". Only if the paymentMethod is "CARD" or "PAYMENT_TERMINAL"                                                                                                                                                                                              |
| cardType                                                                                                | string ( <br/> &nbsp;&nbsp;"CREDIT" <br/> &nbsp;&nbsp;"DEBIT" <br/>) &#124; undefined                                                                                   | The card type. Only if the paymentMethod is "CARD" or "PAYMENT_TERMINAL"                                                                                                                                                                                                                                                    |
| payments                                                                                                | Array &#124; undefined                                                                                                                                                  | All payments used to pay the order.                                                                                                                                                                                                                                                                                         |
| payments[i]                                                                                             | Object                                                                                                                                                                  | Contains the payment information                                                                                                                                                                                                                                                                                            |
