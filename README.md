...
| storeMenu.modifierGroups[i].modifiers[i].name       | string                                                                                                                                                                                                           | Name of the modifier                                                                                                                                                      |
| storeMenu.modifierGroups[i].modifiers[i].hidden     | boolean                                                                                                                                                                                                          | Boolean indicating if the modifier  is a hidden                                                                                                                           |
| storeMenu.modifierGroups[i].modifiers[i].price      | string                                                                                                                                                                                                           | Price of the modifier                                                                                                                                                     |
