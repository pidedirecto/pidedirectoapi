...
| orderItems[i].price                                                                   | string (number)                                                                          | Unit price of this order item                                                                                                                                                                                                                                                                                               |
...
| orderItems[i].modifiers[j].items[k].unitPrice                                         | string (number)                                                                          | Price of this modifier item                                                                                                                                                                                                                                                                                                 |
| orderItems[i].modifiers[j].items[k].quantity                                          | string                                                                                   | Quantity of this modifier item                                                                                                                                                                                                                                                                                              |
...
| orderItems[i].modifiers[j].items[k].subModifier[l].items[m].price                     | string (number)                                                                          | Price of this sub-modifier item                                                                                                                                                                                                                                                                                             |
| orderItems[i].modifiers[j].items[k].subModifier[l].items[m].unitPrice                 | string (number)                                                                          | Price of this sub-modifier item                                                                                                                                                                                                                                                                                             |
| orderItems[i].modifiers[j].items[k].subModifier[l].items[m].quantity                  | string                                                                                   | Quantity of this sub-modifier                                                                                                                                                                                                                                                                                               |
