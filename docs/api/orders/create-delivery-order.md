...
If you have a fixed agreed delivery cost you can omit calling [getDeliveryEstimate](/api/orders/get-delivery-estimate) and skip passing any `deliveryEstimateId`.
